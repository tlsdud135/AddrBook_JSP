<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" errorPage="addrbookError.jsp" import="jspbook.addrbook.*"%>
<!DOCTYPE html>
<html>
<head>
...
<h2>주소록:수정화면</h2>
<hr>
[<a href=addrbookControl.jsp?action=list>주소록 목록으로</a>]<p>
<form name=form1 method=post action=addrbookControl.jsp>
...
<table border="1">
	...
	<tr>
		<th>email</th>
		<td><input type="email" name="ab_email" value="<%=ab.getAb_email()%>"></td>
	</tr>
	<tr>
		<th>전화번호</th>
	...
	<tr>
		...
		<input type=reset value="취소"><input type="button" value="삭제"
		onClick="delcheck()"></td>
	</tr>
</table>
</form>
